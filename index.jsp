		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${HostProduct }" var="p">
			...
			<div class="container-fluid">
				...
				<c:forEach items="${NewProduct }" var="np">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath}/product?method=getById&pid=${np.pid}">
							<img src="${pageContext.request.contextPath}/${np.pimage}" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath}/product?method=getById&pid=${np.pid}" style='color:#666'>${fn:substring(np.pname,0,12) }</a></p>
